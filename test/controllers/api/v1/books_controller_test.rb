...
class Api::V1::BooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_book" do
    assert_difference('Api::V1::Book.count') do
      post api_v1_books_url, params: { api_v1_book: { first_name: @api_v1_book.first_name, last_name: @api_v1_book.last_name } }, as: :json
    end
  ...
  test "should update api_v1_book" do
    patch api_v1_book_url(@api_v1_book), params: { api_v1_book: { first_name: @api_v1_book.first_name, last_name: @api_v1_book.last_name } }, as: :json
    assert_response 200
  end
